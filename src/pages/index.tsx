...
const ContactMailContainer = styled.div`
  display: inline-block;
  margin-right: 20px;
  vertical-align: top;
`;
            ...
            <div class="report-container">
              ...
              <div class="info-item">
                ...
                <span class="info-value">${
                  reportData.conversationDuration
                }</span>
                  </div>
                  <div class="info-underline"></div>
                </div>
              ...
              <div class="contact-info">
                <div class="contact-left">
                  ...
                  <div style="margin-top: 10px;">
                    ...
                    <div style="display: inline-block;  margin-right: 20px; vertical-align: top;">
                      <img src=${
                        window.location.origin + "/logo_1"
                      }.png alt="Logo" width="60" height="60" />
                    </div>
                  </div>
                </div>
        ...
        <ReportCard ref={reportRef} id="report-card">
          ...
          <ContactContainer>
            <div>
              ...
              >
                <img src="/logo_1.png" alt="Logo" width="60" height="60" />
              </div>
            </div>
            <ContactRight>
              This AI chat conversation report and transcript was generated
